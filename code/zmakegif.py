...
if __name__ == '__main__':
    ...
    sdir = "/mnt/d/gk2a_color/%s_IR/"%(tday)
    ofile = "/mnt/d/gk2a_video/%s_IR.gif"%(tday)
    ...
    argv = sys.argv[1:]
    try:
        opts, args = getopt.getopt(argv,"i:o:m:w:h:t:f:d:",["help=","ifile=","ofile=","time=","minute=","width=","height=","day="])
    ...
    for opt, arg in opts:
        ...
        if opt == "--help":
            print('zmakegif.py, i:o:m:w:h:t:f:d:,["day=","help=","ifile=","ofile=","time=","minute=","width=","height="]')
            sys.exit()
        elif opt in ("-i", "--idir"):
            sdir = arg
        elif opt in ("-o", "--ofile"):
